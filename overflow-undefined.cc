...
// * it wraps around according to the rules of the representation
//   (typically 2's complement),
// * it traps — on some platforms or due to compiler options
//   (e.g. -ftrapv in GCC and Clang),
